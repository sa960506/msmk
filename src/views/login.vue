<template>
  ...
  <div class="login">
     ...
     <div class="log" v-show="show">
         <p class="one">
          ...
          <p class="two">
           ...
           <div class="no">
           *未注册的手机号将自动注册
           <button class="btn2" @click="show=false">使用密码登录</button>
         </div>
        <div class="deng">
     ...
     <div class="log" v-show="!show">
         <p class="one">
           <input type="text" v-model="model" placeholder="请输入手机号" name="" id="">
         </p>
          <p class="two">
           <input type="text" v-model="password" placeholder="请输入密码" name="" id="">
         </p>
          
        <p class="tree">
          <input type="text" placeholder="找回密码">
          <span @click="show=true">注册/验证码登录</span>
        </p>
        <div class="deng">
           <van-button class="dl" type="danger" @click="ce"> 登录</van-button>
        </div>
